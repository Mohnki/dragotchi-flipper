...
static void (*const scene_on_enter_handlers[])(void *) = {
    ...
    scene_settings_on_enter, scene_reset_on_enter, scene_about_on_enter, scene_status_on_enter};
static bool (*const scene_on_event_handlers[])(void *, SceneManagerEvent) = {
    ...
    scene_settings_on_event, scene_reset_on_event, scene_about_on_event, scene_status_on_event};
static void (*const scene_on_exit_handlers[])(void *) = {
    ...
    scene_settings_on_exit, scene_reset_on_exit, scene_about_on_exit, scene_status_on_exit};
